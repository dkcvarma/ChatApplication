...
<body style="background-image: url('img/otp1.jpg');">
	<div id="login_widget" style="background-color: rgba(0,0,0,0);margin-right:35%;margin-top:8%;">
		            <section>				
                    <!-- hidden anchor to stop jump http://www.css3create.com/Astuce-Empecher-le-scroll-avec-l-utilisation-de-target#wrap4  -->
                    <div id="wrapper">
                        <div id="login" class="animate form" style="background-color: rgba(0,0,0,0.5);">
                            <form name="myform" method="post"  action="otpprocess.php" autocomplete="on"> 
                                <h1>OTP</h1> 
                                <p>
                                    <input name="otpvalue" required="required" type="text" placeholder="Enter Received OTP"/>
                                </p>
